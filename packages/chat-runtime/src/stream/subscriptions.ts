...
import type { ChatResetReason } from "../journal/replay";
import { readPage, readSince } from "../journal/replay";
...
export class SubscriptionHub {
	...
	constructor(
		private readonly queries: ChatQueries,
	...
	subscribe(
		...
		const replay = options.since
			? readSince(this.queries, sessionId, options.since)
			: readPage(this.queries, sessionId, { limit: this.bootstrapLimit });
